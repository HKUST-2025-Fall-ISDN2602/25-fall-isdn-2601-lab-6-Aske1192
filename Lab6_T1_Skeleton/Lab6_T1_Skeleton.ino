...
#define MOTOR_ENA 23  // Replace the ? with the GPIO pin you selected to connect ENA
#define MOTOR_IN1 21  // Replace the ? with the GPIO pin you selected to connect IN1
#define MOTOR_IN2 22  // Replace the ? with the GPIO pin you selected to connect IN2

//Encoder Pin 
#define ENCODER_PINA 19 // Replace the ? with the GPIO pin you selected to connect encoder A
#define ENCODER_PINB 18 // Replace the ? with the GPIO pin you selected to connect encoder B
...
double getPosition() {
  ...
  position = float(encoderCount)*360.0/198.5; // Replace 1000.0 with the actual counts per revolution
